package cn.kane.jvm.chap8.jndi;
...
{
	/**
	 * u can run-VM-config [-DsocksProxyHost=proxy.asiainfo-linkage.com -DsocksProxyPort=8080]
	 * @param args
...
//		String domain = args[0];
		...
		/*上面的整段程序代码也可以用下面这段程序代码来替代，下面这段程序代码通过查询URL中的Schema信息来自动选择Context的工厂类*/
		/*
