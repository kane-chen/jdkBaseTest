...
public class Occupy extends Object{
    ...
    private List<Object> dedup = new ArrayList<Object>();
    ...
    private static int occupyofConstructor(Object object, Field field) {
        throw new UnsupportedOperationException("field type Constructor not accessible: "
                + object.getClass() + " field:" + field);
    }
    ...
    private static int sizeofPrimitiveClass(Class<?> clazz) {
        return clazz == boolean.class || clazz == byte.class ? 1 : clazz == char.class
                || clazz == short.class ? 2 : clazz == int.class || clazz == float.class ? 4 : 8;
    }
